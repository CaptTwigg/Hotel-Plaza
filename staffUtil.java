...
public class StaffUtil
{
 ...
 public static void loadstaff(String file, ArrayList<Staff> staffs) throws Exception
 {
  ...
  while (Filereader.hasNextLine())
  {
     ...
     //staffs.add(new Staff(staffscan.next(), staffscan.next(), staffscan.next(), staffscan.nextInt()));
     staffscan.close();
  }
    Filereader.close();
  }
